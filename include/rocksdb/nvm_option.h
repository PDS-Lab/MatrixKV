...
namespace rocksdb {
  ...
  static const uint64_t Level0_column_compaction_trigger_size = 9ul * 1024 * 1024 * 1024; //7G trigger
  static const uint64_t Level0_column_compaction_slowdown_size = 9ul * 1024 * 1024 * 1024 + 512ul * 1024 * 1024; //7.5G slowdown
  static const uint64_t Level0_column_compaction_stop_size = 10ul * 1024 * 1024 * 1024; //8G stop
